...
export const environment = {
  ...
  spotify: {
    ...
    scope: 'user-read-playback-state user-read-currently-playing user-modify-playback-state streaming app-remote-control playlist-read-collaborative playlist-modify-private playlist-modify-public playlist-read-private user-read-birthdate user-read-email user-read-private user-library-read',
