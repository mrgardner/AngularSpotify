...
describe('SpotifyGuard', () => {
  ...
  it('should create spotify guard with token', () => {
    ...
    spotifyGuard = new SpotifyGuard(router, authService);
    expect(spotifyGuard.canActivate(new ActivatedRouteSnapshot(), mockSnapshot)).toBeTruthy();
  });
  ...
  it('should create spotify guard without token', () => {
    ...
    spotifyGuard = new SpotifyGuard(router, authService);
    expect(spotifyGuard.canActivate(new ActivatedRouteSnapshot(), mockSnapshot)).toBeFalsy();
