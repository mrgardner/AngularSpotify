...
// Components
import { DeviceModalComponent } from '@bottom-bar/components/device-modal/device-modal.component';

// Interfaces
import { Device } from '@core/interfaces/device/device.interface';
import { SpotifyDeviceResponse } from '@core/interfaces/device/device.interface';
import { SpotifySongResponse } from '@core/interfaces/song/song.interface';
import { Track } from '@core/interfaces/track/track.interface';

// Services
import { DeviceModalService } from '@bottom-bar/services/device-modal/device-modal.service';
