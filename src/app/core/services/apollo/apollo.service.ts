...
// Interfaces
import { ApolloAlbumResult, AlbumApolloResponse } from '@core/interfaces/apollo/apollo.inerface';

// Queries
import { ALBUM_INFO } from '@core/queries/get-albums';
import { FOLLOWED_ARTISTS } from '@core/queries/get-artists';
import { PLAYLIST_NAME, PLAYLIST_TRACKS, PLAYLIST_INFO } from '@core/queries/get-playlists';
import { USER_DISPLAY_NAME } from '@core/queries/get-user';
